...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(36, 36, "end", "model_dm_glm_mc_psi");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        validate_non_negative_index("beta", "K", K);
        validate_non_negative_index("beta", "P", P);
        beta = matrix_d(static_cast<Eigen::VectorXd::Index>(K),static_cast<Eigen::VectorXd::Index>(P));
        vals_r__ = context__.vals_r("beta");
        pos__ = 0;
        size_t beta_m_mat_lim__ = K;
        size_t beta_n_mat_lim__ = P;
        for (size_t n_mat__ = 0; n_mat__ < beta_n_mat_lim__; ++n_mat__) {
            for (size_t m_mat__ = 0; m_mat__ < beta_m_mat_lim__; ++m_mat__) {
                beta(m_mat__,n_mat__) = vals_r__[pos__++];
            }
        }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("residual")))
            throw std::runtime_error("variable residual missing");
        vals_r__ = context__.vals_r("residual");
        pos__ = 0U;
        validate_non_negative_index("residual", "N", N);
        validate_non_negative_index("residual", "K", K);
        context__.validate_dims("initialization", "residual", "vector_d", context__.to_vec(N,K));
        // generate_declaration residual
        std::vector<vector_d> residual(N,vector_d(static_cast<Eigen::VectorXd::Index>(K)));
        for (int j1__ = 0U; j1__ < K; ++j1__)
            for (int i0__ = 0U; i0__ < N; ++i0__)
                residual[i0__](j1__) = vals_r__[pos__++];
        for (int i0__ = 0U; i0__ < N; ++i0__)
            try {
            writer__.vector_unconstrain(residual[i0__]);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable residual: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        vector<Eigen::Matrix<T__,Eigen::Dynamic,1> > residual;
        size_t dim_residual_0__ = N;
        residual.reserve(dim_residual_0__);
        for (size_t k_0__ = 0; k_0__ < dim_residual_0__; ++k_0__) {
            if (jacobian__)
    ...
    void write_array(RNG& base_rng__,
        ...
        for (int k_1__ = 0; k_1__ < K; ++k_1__) {
            for (int k_0__ = 0; k_0__ < N; ++k_0__) {
                vars__.push_back(residual[k_0__][k_1__]);
            }
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_1__ = 1; k_1__ <= K; ++k_1__) {
            for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "residual" << '.' << k_0__ << '.' << k_1__;
                param_names__.push_back(param_name_stream__.str());
            }
        }
