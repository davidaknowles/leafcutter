...
namespace model_dm_all_namespace {
...
class model_dm_all : public prob_grad {
private:
    int N;
    int P;
    int K;
    ...
    double concRate;
public:
    model_dm_all(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dm_all_namespace::model_dm_all";
        (void) function__; // dummy call to supress warning
        size_t pos__;
        (void) pos__; // dummy call to supress warning
        std::vector<int> vals_i__;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_dm_all_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
...
namespace model_dm_glm_fixed_conc_namespace {
...
class model_dm_glm_fixed_conc : public prob_grad {
private:
    int N;
    int P;
    int K;
    ...
    vector<double> conc;
public:
    model_dm_glm_fixed_conc(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dm_glm_fixed_conc_namespace::model_dm_glm_fixed_conc";
        (void) function__; // dummy call to supress warning
        size_t pos__;
        (void) pos__; // dummy call to supress warning
        std::vector<int> vals_i__;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_dm_glm_fixed_conc_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        vector<vector_d> beta_raw;
        size_t dim_beta_raw_0__ = P;
    ...
    static std::string model_name() {
        return "model_dm_glm_fixed_conc";
    }
...
namespace model_dm_glm_log_normal_namespace {
...
dirichlet_multinomial_log(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& y,
                              const Eigen::Matrix<T1__, Eigen::Dynamic,1>& a, std::ostream* pstream__) {
    ...
    try {
        {
            ...
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  aPlusY(static_cast<Eigen::VectorXd::Index>(rows(y)));
            (void) aPlusY;  // dummy to suppress unused var warning
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  lGaPlusY(static_cast<Eigen::VectorXd::Index>(rows(y)));
            (void) lGaPlusY;  // dummy to suppress unused var warning
            Eigen::Matrix<fun_scalar_t__,Eigen::Dynamic,1>  lGaA(static_cast<Eigen::VectorXd::Index>(rows(y)));
            (void) lGaA;  // dummy to suppress unused var warning
            stan::math::initialize(suma, std::numeric_limits<double>::quiet_NaN());
            stan::math::initialize(lp, std::numeric_limits<double>::quiet_NaN());
            stan::math::initialize(aPlusY, std::numeric_limits<double>::quiet_NaN());
            stan::math::initialize(lGaPlusY, std::numeric_limits<double>::quiet_NaN());
            stan::math::initialize(lGaA, std::numeric_limits<double>::quiet_NaN());
            current_statement_begin__ = 9;
            stan::math::assign(K, rows(y));
            current_statement_begin__ = 10;
            stan::math::assign(suma, sum(a));
            current_statement_begin__ = 11;
            stan::math::assign(aPlusY, add(a,y));
            ...
            current_statement_begin__ = 16;
            return stan::math::promote_scalar<fun_return_scalar_t__>((((lgamma(suma) + sum(lGaPlusY)) - lgamma((suma + sum(y)))) - sum(lGaA)));
        }
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e,current_statement_begin__);
        // Next line prevents compiler griping about no return
...
dirichlet_multinomial_log(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& y,
                              const Eigen::Matrix<T1__, Eigen::Dynamic,1>& a, std::ostream* pstream__) {
    return dirichlet_multinomial_log<false>(y,a, pstream__);
}


struct dirichlet_multinomial_log_functor__ {
    template <bool propto, typename T0__, typename T1__>
    inline
    typename boost::math::tools::promote_args<T0__, T1__>::type
    operator()(const Eigen::Matrix<T0__, Eigen::Dynamic,1>& y,
                              const Eigen::Matrix<T1__, Eigen::Dynamic,1>& a, std::ostream* pstream__) const {
        return dirichlet_multinomial_log(y, a, pstream__);
    }
};

class model_dm_glm_log_normal : public prob_grad {
private:
    int N;
    int P;
    int K;
    ...
    double sigma;
public:
    model_dm_glm_log_normal(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dm_glm_log_normal_namespace::model_dm_glm_log_normal";
        (void) function__; // dummy call to supress warning
        size_t pos__;
        (void) pos__; // dummy call to supress warning
        std::vector<int> vals_i__;
        ...
        mu = vector_d(static_cast<Eigen::VectorXd::Index>(K));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("log_dispersion")))
            throw std::runtime_error("variable log_dispersion missing");
        vals_r__ = context__.vals_r("log_dispersion");
        pos__ = 0U;
        context__.validate_dims("initialization", "log_dispersion", "double", context__.to_vec(K));
        std::vector<double> log_dispersion(K,double(0));
        for (int i0__ = 0U; i0__ < K; ++i0__)
            log_dispersion[i0__] = vals_r__[pos__++];
        for (int i0__ = 0U; i0__ < K; ++i0__)
            try {
            writer__.scalar_unconstrain(log_dispersion[i0__]);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable log_dispersion: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        vector<T__> log_dispersion;
        size_t dim_log_dispersion_0__ = K;
        log_dispersion.reserve(dim_log_dispersion_0__);
        for (size_t k_0__ = 0; k_0__ < dim_log_dispersion_0__; ++k_0__) {
            if (jacobian__)
                log_dispersion.push_back(in__.scalar_constrain(lp__));
            else
                log_dispersion.push_back(in__.scalar_constrain());
        }
        ...
        try {
            {
                ...
                current_statement_begin__ = 39;
                lp_accum__.add(normal_log<propto__>(log_dispersion, mu, sigma));
                current_statement_begin__ = 40;
                for (int n = 1; n <= N; ++n) {
                    {
                        Eigen::Matrix<T__,Eigen::Dynamic,1>  a(static_cast<Eigen::VectorXd::Index>(K));
                        ...
                        for (int k = 1; k <= K; ++k) {
                            ...
                            stan::math::assign(get_base1_lhs(a,k,"a",1), (exp(-(get_base1(log_dispersion,k,"log_dispersion",1))) * get_base1(s,k,"s",1)));
                        }
                        current_statement_begin__ = 46;
                        lp_accum__.add(dirichlet_multinomial_log<propto__>(get_base1(y,n,"y",1), a, pstream__));
                    }
                }
            }
        } catch (const std::exception& e) {
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("beta_raw");
        names__.push_back("beta_scale");
        names__.push_back("log_dispersion");
    }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_dm_glm_log_normal_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        vector<vector_d> beta_raw;
        size_t dim_beta_raw_0__ = P;
        ...
        for (int k_0__ = 0; k_0__ < K; ++k_0__) {
            vars__.push_back(log_dispersion[k_0__]);
        }
    ...
    static std::string model_name() {
        return "model_dm_glm_log_normal";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= K; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "log_dispersion" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
...
namespace model_dm_simplex_log_normal_namespace {
...
class model_dm_simplex_log_normal : public prob_grad {
private:
    int N;
    int K;
    vector<vector_d> y;
    ...
    double sigma;
public:
    model_dm_simplex_log_normal(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dm_simplex_log_normal_namespace::model_dm_simplex_log_normal";
        (void) function__; // dummy call to supress warning
        size_t pos__;
        (void) pos__; // dummy call to supress warning
        std::vector<int> vals_i__;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        if (!(context__.contains_r("proportion")))
            throw std::runtime_error("variable proportion missing");
        vals_r__ = context__.vals_r("proportion");
        pos__ = 0U;
        context__.validate_dims("initialization", "proportion", "vector_d", context__.to_vec(K));
        vector_d proportion(static_cast<Eigen::VectorXd::Index>(K));
        for (int j1__ = 0U; j1__ < K; ++j1__)
            proportion(j1__) = vals_r__[pos__++];
        try {
            writer__.simplex_unconstrain(proportion);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable proportion: ") + e.what());
        }
        ...
        vals_r__ = context__.vals_r("log_dispersion");
        pos__ = 0U;
        context__.validate_dims("initialization", "log_dispersion", "vector_d", context__.to_vec(K));
        vector_d log_dispersion(static_cast<Eigen::VectorXd::Index>(K));
        for (int j1__ = 0U; j1__ < K; ++j1__)
            log_dispersion(j1__) = vals_r__[pos__++];
        try {
            writer__.vector_unconstrain(log_dispersion);
        } catch (const std::exception& e) { 
            throw std::runtime_error(std::string("Error transforming variable log_dispersion: ") + e.what());
        }
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        Eigen::Matrix<T__,Eigen::Dynamic,1>  proportion;
        (void) proportion;  // dummy to suppress unused var warning
        if (jacobian__)
            proportion = in__.simplex_constrain(K,lp__);
        else
            proportion = in__.simplex_constrain(K);

        Eigen::Matrix<T__,Eigen::Dynamic,1>  log_dispersion;
        (void) log_dispersion;  // dummy to suppress unused var warning
        if (jacobian__)
            log_dispersion = in__.vector_constrain(K,lp__);
        else
            log_dispersion = in__.vector_constrain(K);
        ...
        try {
            {
                Eigen::Matrix<T__,Eigen::Dynamic,1>  conc(static_cast<Eigen::VectorXd::Index>(K));
                (void) conc;  // dummy to suppress unused var warning
                Eigen::Matrix<T__,Eigen::Dynamic,1>  a(static_cast<Eigen::VectorXd::Index>(K));
                (void) a;  // dummy to suppress unused var warning
                ...
                lp_accum__.add(normal_log<propto__>(log_dispersion, mu, sigma));
                current_statement_begin__ = 34;
                stan::math::assign(conc, exp(minus(log_dispersion)));
                current_statement_begin__ = 35;
                for (int k = 1; k <= K; ++k) {
                    current_statement_begin__ = 36;
                    stan::math::assign(get_base1_lhs(a,k,"a",1), (get_base1(proportion,k,"proportion",1) * get_base1(conc,k,"conc",1)));
                }
                current_statement_begin__ = 38;
                for (int n = 1; n <= N; ++n) {
                    current_statement_begin__ = 39;
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_dm_simplex_log_normal_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        vector_d proportion = in__.simplex_constrain(K);
        vector_d log_dispersion = in__.vector_constrain(K);
        for (int k_0__ = 0; k_0__ < K; ++k_0__) {
            vars__.push_back(proportion[k_0__]);
        }
        for (int k_0__ = 0; k_0__ < K; ++k_0__) {
            vars__.push_back(log_dispersion[k_0__]);
        }
    ...
    static std::string model_name() {
        return "model_dm_simplex_log_normal";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= K; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "proportion" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= K; ++k_0__) {
            param_name_stream__.str(std::string());
...
namespace model_fit_conc_namespace {
...
class model_fit_conc : public prob_grad {
private:
    int N;
    vector<double> y;
    vector<double> mu;
public:
    model_fit_conc(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        typedef boost::ecuyer1988 rng_t;
        rng_t base_rng(0);  // 0 seed default
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_fit_conc_namespace::model_fit_conc";
        (void) function__; // dummy call to supress warning
        size_t pos__;
        (void) pos__; // dummy call to supress warning
        std::vector<int> vals_i__;
        ...
        context__.validate_dims("data initialization", "mu", "double", context__.to_vec(N));
        validate_non_negative_index("mu", "N", N);
        mu = std::vector<double>(N,double(0));
        vals_r__ = context__.vals_r("mu");
        pos__ = 0;
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                current_statement_begin__ = 12;
                lp_accum__.add(normal_log<propto__>(get_base1(y,n,"y",1), log((b + (a / get_base1(mu,n,"mu",1)))), 1));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<double> in__(params_r__,params_i__);
        static const char* function__ = "model_fit_conc_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
